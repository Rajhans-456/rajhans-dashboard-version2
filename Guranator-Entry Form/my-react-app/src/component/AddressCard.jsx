  ...
  return (
    <div className="address-card">
      ...
      <div className="form-group">
        <label className="form-label">Address Line 1 {isRequired && "*"}</label>
        <input
          type="text"
      ...
      <div className="form-group">
        <label className="form-label">City {isRequired && "*"}</label>
        <select
      ...
      <div className="form-group">
        <label className="form-label">PIN Code {isRequired && "*"}</label>
        <input
          type="text"
          className="form-input"
          value={data.pinCode || ""}
