...
const OtherChargesCollectionReport = () => {
  ...
  const handleGetReport = () => {
    console.log('Generate other charges collection report with:', {
      reportDuration,
      fromDate,
      toDate
    });
  ...
  const handleExportToExcel = () => {
    console.log('Export other charges collection report to Excel');
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="border-b-4 border-teal-300 pb-4 mb-8">
            <h2 className="text-2xl font-bold text-blue-800 tracking-wide">OTHER CHARGES COLLECTION REPORT</h2>
          </div>
...
export default OtherChargesCollectionReport;