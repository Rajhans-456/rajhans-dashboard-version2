...
const LoanWiseCollectionPaymentSent = () => {
  ...
  const handleExportToExcel = () => {
    console.log('Export loan-wise collection report to Excel with:', {
      loanType,
      filterBy,
      fromMonth,
      fromYear,
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="border-b-4 border-teal-300 pb-4 mb-8">
            <h2 className="text-2xl font-bold text-blue-800 tracking-wide">LOAN-WISE COLLECTION & PAYMENT SENT</h2>
          </div>

          {/* Form Fields */}
          <div className="space-y-6 mb-8">
            <div className="flex items-center">
              <label className="w-32 text-gray-700 font-medium">Loan Type:</label>
              <select
                value={loanType}
            ...
            <div className="flex items-center">
              <label className="w-32 text-gray-700 font-medium">Filter By:</label>
              <select
                value={filterBy}
            ...
            <div className="flex items-center">
              <label className="w-32 text-gray-700 font-medium">HP Name:</label>
              <select
                value={hpName}
...
export default LoanWiseCollectionPaymentSent;