...
import "../../style/UpdateExtEMIDate.css";

const UpdateExtEMIDate = () => {
      ...
      <div className="main-content">
        ...
        <div className="form-container">
          ...
          <div className="form-content">
            ...
            <div className="form-row">
              <div className="form-group">
                <label className="form-label">Veh Regn No :</label>
                <input
                  type="text"
                  name="vehRegnNo"
                  value={formData.vehRegnNo}
                  onChange={handleInputChange}
                  className="form-input"
                />
              </div>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                <label className="form-label">First Ext EMI Date:</label>
                <input
                  type="text"
                  name="firstExtEMIDate"
                  value={formData.firstExtEMIDate}
                  onChange={handleInputChange}
                  className="form-input"
            ...
            <div className="form-row">
              <div className="form-group">
                <label className="form-label">Ext Party Name:</label>
                <input
                  type="text"
                  name="extPartyName"
                  value={formData.extPartyName}
                  onChange={handleInputChange}
                  className="form-input"
                />
              </div>
...
export default UpdateExtEMIDate;
