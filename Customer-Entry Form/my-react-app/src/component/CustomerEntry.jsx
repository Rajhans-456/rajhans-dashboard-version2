...
import '../component/CustomerEntry.css';
    ...
    <div className="main-container">
      ...
      <div className="main-content">
        <div className="page-header">
          <h1 className="page-title">New Customer Entry</h1>
       ...
       <button className="btn btn-primary" onClick={() => handleSaveAndGoto("/co-borrower-entry")}>
          Save and Go to Co-Borrower Entry
        </button>
         <button className="btn btn-primary" onClick={() => handleSaveAndGoto("/co-guarantor-entry")}>
         Save and Go to Co-Guarantor Entry
       </button>
